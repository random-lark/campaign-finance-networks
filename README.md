...
In this project I model campaign finance as an absorbing Markov chain. As such, to "follow the money" is to follow the random walk of money. Using this model, I empirically infer entity ideologies and subsequently compare Democratic and Republican random walk dynamics.  
